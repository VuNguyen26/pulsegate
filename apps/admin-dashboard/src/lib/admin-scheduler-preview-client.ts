...
function unavailableError():
  ...
  return {
    ...
    message:
      "The Dashboard scheduler preview is unavailable.",
    requestId: null,
  };
}
...
function invalidResponseError():
  ...
  return {
    ...
    message:
      "The Dashboard received an invalid scheduler preview response.",
    requestId: null,
  };
}
...
export async function loadDashboardSchedulerPreview(
